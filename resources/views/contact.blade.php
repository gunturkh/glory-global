  ...
  <div class="ubea-container">
    ...
    <div class="row mb-4" style="justify-content: center;">
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          ...
          <span class="font-italic font-weight-light">Marketing Manager</span>
          <hr />
    ...
    <div class="row mb-4">
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          ...
          <small class="block" style="font-size: 14px"><a href="mailto:marcomartinus@gloriglobalsukses.com?Subject=Inquiry%20on%20Importir" target="_top">marcomartinus@gloriglobalsukses.com</a></small>
        </center>
      </div>
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
      ...
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          ...
          <small class="block" style="font-size: 14px"><a href="mailto:feliciaeliyana@gloriglobalsukses.com?Subject=Inquiry%20on%20Importir" target="_top">feliciaeliyana@gloriglobalsukses.com</a></small>
        </center>
      </div>
    </div>
    <div class="row mb-4">
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          <span class="font-weight-bold">PT Glori Global Sukses</span>
          <hr />
          <img class="image-responsive" src="{{url('contact/fian.jpg')}}" style="border-radius: 50%; height: 300px; width: auto; object-fit: cover; object-position: top;">
          <h4 class="contact-name">Fian Pranatha</h4>
          <span class="font-italic font-weight-light">Marketing Exclusive</span>
          <hr />
      ...
      <div class="col-sm-4">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          <span class="font-weight-bold">PT Glori Global Sukses</span>
          <hr />
          <img class="image-responsive" src="{{url('contact/sandra.jpg')}}" style="border-radius: 50%; height: 300px; width: auto; object-fit: cover; object-position: top;">
          <h4 class="contact-name">Sandra Carren</h4>
          <span class="font-italic font-weight-light">Marketing Exclusive</span>
          <hr />
      ...
      <div class="col-sm-3">
        <center class="card" style="max-width: 400px; margin: 20px auto;">
          <span class="font-weight-bold">PT Glori Global Sukses</span>
          <hr />
          <img class="image-responsive" src="{{url('contact/selena.jpg')}}" style="border-radius: 50%; height: 300px; width: auto; object-fit: cover; object-position: top;">
      <h4 class="contact-name">Selena Aprilia</h4>
      <span class="font-italic font-weight-light">Marketing Exclusive</span>
      <hr />
      <div style="font-size: 16px">(+62) 822 8903 9250</div>
      <small class="block" style="font-size: 14px"><a href="mailto:info@gloriglobalsukses.com?Subject=Inquiry%20on%20Importir" target="_top">info@gloriglobalsukses.com</a></small>
      </center>
    </div>
    --}}
    <div class="col-sm-4">
      <center class="card" style="max-width: 400px; margin: 20px auto;">
        <span class="font-weight-bold">PT Glori Global Sukses</span>
        <hr />
        <img class="image-responsive" src="{{url('contact/christian.jpg')}}" style="border-radius: 50%; height: 300px; width: auto; object-fit: cover; object-position: top;">
        <h4 class="contact-name">Christian Pangalila</h4>
        <span class="font-italic font-weight-light">Marketing Exclusive</span>
        <hr />
