...
<div class="ubea-section mt-10" id="ubea-faq" data-section="faq">
  <div class="ubea-container">
    <div class="row justify-content-center">
      <div class="col-md-8 text-center ubea-heading">
        <h2>Pertanyaan yang sering ditanyakan</h2>
        <p>Untuk calon para reseller yang ingin bergabung, ada kalanya membaca pertanyaan pertanyaan umum yang mungkin akan ditanyakan untuk memperlancar proses kegiatan import</p>
      </div>
    </div>
    <div class="container">
