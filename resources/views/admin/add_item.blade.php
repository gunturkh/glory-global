      ...
      <div class="col-md-5 mb-4">
        <form action="#" method="post" enctype="multipart/form-data">
          <div class="form-group {{$errors->has('product_name') ? 'has-error' : ''}}">
            ...
            <input type="text" name="product_name" id="product_name" class="form-control" value="{{Request::old('product_name')}}" onchange="updateTitlePreview(this.value)">
            @error('product_name')
          ...
          <div class="form-group {{$errors->has('product_description') ? 'has-error' : ''}}">
            ...
            <textarea maxlength="500" name="product_description" id="product_description" class="form-control" rows="5" value="{{Request::old('product_description')}}" onchange="updateDescriptionPreview(this.value)"></textarea>
          ...
          <div class="form-group {{$errors->has('product_price') ? 'has-error' : ''}}">
            ...
            <input type="number" name="product_price" id="product_price" class="form-control" value="{{Request::old('product_price')}}" onchange="updatePricePreview(this.value)">
            @error('product_price')
              <div style="font-size: 1em; color: firebrick; ">{{$message}}</div>
            @enderror
          </div>
          <div class="form-group {{$errors->has('product_price2') ? 'has-error' : ''}}">
            ...
            <input type="number" name="product_price2" id="product_price2" class="form-control" value="{{Request::old('product_price2')}}" onchange="updatePrice2Preview(this.value)">
      ...
      <div class="col-md-3 mb-4" style="opacity: .6">
        <div class="card">
          <figure style="height:300px;">
            <img id="image-preview" src="images/image_preview.jpg" alt="Image Preview" class="image-responsive image-card" style="max-height:100%; max-width: 100%">
          </figure>
          <div class="col-md-12">
              <h4 style="font-weight: 400; color: #666;" id="TitlePreview"><center>---Kosong---</center></h4>
              <p id="DescriptionPreview"><i>---Kosong---</i></p>
              <div style="color:#666;">Batam <p class="price-card" id="PricePreview">---Kosong---</p></div>
              <div style="color:#666;">Jakarta <p class="price-card" id="Price2Preview">---Kosong---</p></div>
          </div>
        </div>        
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="cancelUpdateModalLabel">Membatalkan Penambahan?</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              Apakah anda yakin untuk membatalkan penambahan Item? Data yang telah diubah tidak akan disimpan
            </div>
            <div class="modal-footer">
              <a class="btn btn-secondary" href="{{url('product')}}">Saya yakin</a>
