(function() {
    ...
    var offcanvasMenu = function() {
        ...
        var clone3 = $(".menu-3 > *").clone();
        $("#ubea-offcanvas").append(clone3);
    ...
    var goToTop = function() {
        ...
        $("#page").scroll(function() {
            var $win = $(window);
            var $page = $("#page");
            // console.log("wind: ", $win.scrollTop());
            // console.log("page: ", $page.scrollTop());
